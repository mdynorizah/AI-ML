...
# print('Sum of 10,10,100,100,200,219,19 is: \t',add(10,20,100,100,200,219,19))
...
print('Maximum 10,10,100,100,200,219,19 is: \t',max(10,20,100,100,200,219,19))

print('Minimum Example')
print('Min of 1,10,11 is: \t',min(1,10,11))
print('Min of 5,2 is: \t',min(5,2))
print('Min 10,10,100,100,200,219,19 is: \t',min(10,20,100,100,200,219,19))
