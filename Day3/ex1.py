# print("Welcome to Day Three:DataStructure")
...
# # newEmp=input("\nEnter employee fanme to add in list:\t")
# # emps.append(newEmp)
...
# append, remove, pop inser method
...
#pop() example
#listName.pop(item): Will delete element at give index and return its value.
# emps=["sam","ravi","ani","zoya","vi","sa","chang","neha"]
# print("Number of Employees",len(emps))
# for emp in emps:
#      print(emp,end=" ")

# del_index=int (input('Enter Index to pop:\t'))
